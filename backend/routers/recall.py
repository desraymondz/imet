...
def search_contacts(
    ...
    """
    Hybrid recall: query understanding to extract in_scope and keywords
    ...
    # Phase 1: understand query (scope, FTS keywords)
    ...
    logger.info(
        "Recall query plan: in_scope=%s keywords=%r",
        plan.in_scope,
        plan.keywords,
    )
    ...
    # Phase 2b: semantic retrieve (embed the raw user query, rank by cosine similarity)
